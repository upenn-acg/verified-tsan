...
Lemma can_arw_SC_iff: forall p m v t,
  consistent (m ++ [ARW t p 0 v]) <-> can_write (m ++ [Read t p 0]) p. 
Proof.
...
Lemma can_arw_SC : forall p m (Hcan_r : can_read m p 0)
  (Hcan_w: can_write m p) t v, consistent (m ++ [ARW t p 0 v]).
Proof.
  intros.
              ...
              (map (C0 t0) (rev (interval 0 zt))) zt t0)).
      {
        ...
        -split; clarify.
         ...
         +apply (mops_hb_check_con Hs); auto.
          eapply consistent_app_SC; auto.
        -repeat (rewrite Forall_forall; intros).
         inversion H; clarify.
         apply in_mops_hb_check in H2.
         destruct x1 ; clarify.
         inversion H2; clarify; intro Heq; clarify;
          admit. (* X & W , X & C don't overlap*)
      }
