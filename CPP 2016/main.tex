...
\TODO{Make this a bit less of a red herring.}
...
\\ & & \hl{ \incvc{u}{C[u]}\texttt{;} }
  \end{tabular}
\caption{Unsynchronized instrumented versions of each instruction, with instrumentation highlighted in gray.}
