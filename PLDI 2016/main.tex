...
\newcommand{\execstar}[4]{\ensuremath{(#1, #2) \xrightarrow{#3} #4}}
...
\begin{figure}[htb]
\bigcell{
\inference{}{\exec{P \uplus (t, \assign{a}{e}\texttt{;} \mathit{li}, G)}{m}{t}{}{(P \uplus (t, \mathit{li}, G[a \mapsto \mathsf{eval}(G, e)]), m)}}\\\\

\inference{\mathsf{read}(m, p) = v}{\exec{P \uplus (t, \load{a}{p}\texttt{;} \mathit{li}, G)}{m}{t}{\mathit{rd}(t, p)}{(P \uplus (t, \mathit{li}, G[a \mapsto v]), m)}}\\\\

\inference{\mathsf{write}(m, p, v) = m'}{\exec{P \uplus (t, \store{p}{e}\texttt{;} \mathit{li}, G)}{m}{t}{\mathit{wr}(t, p)}{(P \uplus (t, \mathit{li}, G), m')}}\\\\

\inference{\mathsf{write}(m, \ell, t + 1) = m'}{\exec{P \uplus (t, \lock{\ell}\texttt{;} \mathit{li}, G)}{m}{t}{\mathit{acq}(t, \ell)}{(P \uplus (t, \mathit{li}, G), m')}}\\\\

\inference{\mathsf{write}(m, \ell, 0) = m'}{\exec{P \uplus (t, \unlock{\ell}\texttt{;} \mathit{li}, G)}{m}{t}{\mathit{rel}(t, \ell)}{(P \uplus (t, \mathit{li}, G), m)}}\\\\

\inference{\forall \mathit{li}' G'.\ (t, \mathit{li}', G') \not\in P}{\exec{P \uplus (t, \spawn{u}{\mathit{li}'}\texttt{;} \mathit{li}, G)}{m}{t}{\mathit{fork}(t, u)}{(P \uplus (t, \mathit{li}, G) \uplus (u, \mathit{li}', G_0), m)}}\\\\

\inference{(u, \cdot, G') \in P}{\exec{P \uplus (t, \wait{u}\texttt{;} \mathit{li}, G)}{m}{t}{\mathit{join}(t, u)}{(P \uplus (t, \mathit{li}, G), m)}}\\\\

\inference{\mathsf{eval}(G, e_1) \le \mathsf{eval}(G, e_2)}{\exec{P \uplus (t, \assert{e_1}{e_2}\texttt{;} \mathit{li}, G)}{m}{t}{}{(P \uplus (t, \mathit{li}, G), m)}}\\\\

\inference{\mathsf{eval}(G, e_1) > \mathsf{eval}(G, e_2)}{\exec{P \uplus (t, \assert{e_1}{e_2}\texttt{;} \mathit{li}, G)}{m}{t}{}{\mathit{err}}}
}
