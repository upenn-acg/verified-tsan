...
\\ \qquad \anarrow{t}{} \quad 
\cfg{P \uplus (t, \mathit{li}, G[a \mapsto \mathsf{eval}(G, e)])}{m}
\\\\

\multicolumn{1}{c}{\mathsf{read}(m, p) = v} 
\\ \hline
\cfg{P \uplus (t, \load{a}{p}\texttt{;} \mathit{li}, G)}{m}  
\\ \qquad \anarrow{t}{\mathit{rd}(t, p)} \quad  
\cfg{P \uplus (t, \mathit{li}, G[a \mapsto v)]}{m}
\\\\

\multicolumn{1}{c}{\mathsf{write}(m, p, v) = m'} 
\\ \hline
\cfg{P \uplus (t, \store{p}{e}\texttt{;} \mathit{li}, G)}{m} 
\\ \qquad \anarrow{t}{\mathit{wr}(t, p)} \quad
\cfg{P \uplus (t, \mathit{li}, G)}{m'}
\\\\

\multicolumn{1}{c}{\mathsf{write}(m, \ell, t + 1) = m'} 
\\ \hline
\cfg{P \uplus (t, \lock{\ell}\texttt{;} \mathit{li}, G)}{m}
\\ \qquad \anarrow{t}{\mathit{acq}(t, \ell)} \quad
\cfg{P \uplus (t, \mathit{li}, G)}{m'}
\\\\

\multicolumn{1}{c}{\mathsf{write}(m, \ell, 0) = m'} 
\\ \hline
\cfg{P \uplus (t, \unlock{\ell}\texttt{;} \mathit{li}, G)}{m}
\\ \qquad \anarrow{t}{\mathit{rel}(t, \ell)} \quad
\cfg{P \uplus (t, \mathit{li}, G}{m}
\\\\
...
\\ \qquad \anarrow{t}{\mathit{fork}(t, u)} \quad
...
\\ \qquad \anarrow{t}{\mathit{join}(t, u)} \quad
\cfg{P \uplus (t, \mathit{li}, G)}{m}
\\\\
