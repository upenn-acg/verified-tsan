...
\multicolumn{1}{c}{\mathsf{read}(m, p) = v \quad \forall o.\ (W[p], o) \le (C[t], o)}
\\
\multicolumn{1}{c}{\mathsf{read}(m, X[p]) = 0 \quad m' = \mathsf{write}(m, (C[t], t), (R[x], t))}
\\
\hline
\cfg{P \uplus (t, \instr{t}{\load{a}{p}}\texttt{;} \mathit{li}, G)}{m}
\\ \qquad \Rightarrow_{t} \quad 
\cfg{P \uplus (t, \mathit{li}, G[a \mapsto v, \texttt{tmp1} \mapsto ?, \texttt{tmp2} \mapsto ?]}{m'}
\end{array}
\]
