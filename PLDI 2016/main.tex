...
%During the verification process, we discovered issues \TODO{tone this down?} in both the paper proof and the implementation of the \FT race detection algorithm.
\end{abstract}
...
\end{itemize}
Along the way, we discovered that one lemma in the paper proof of \FT needed strengthening, and noticed a minor discrepancy between the \FT algorithm and its implementation. This highlights the value of formal verification for obtaining correct algorithms and implementations.
